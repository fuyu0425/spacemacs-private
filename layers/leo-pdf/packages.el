...
(setq leo-pdf-packages '(
                         ;; (pdf-tools :location local)
                         (pdf-tools :location (recipe  :fetcher github :repo "flatwhatson/pdf-tools" :branch "fix-macros"
                                                       :files ("lisp/*.el"
                                                               "README"
                                                               ("build" "Makefile")
                                                               ("build" "server")
