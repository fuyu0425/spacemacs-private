...
(defun leo-ibuffer/init-ibuffer()
  (use-package ibuffer
    :defer t
    :init
    (progn
...
(defun leo-ibuffer/init-ibuffer-projectile()
...
(defun leo-ibuffer/init-ibuffer-vc()
  (use-package ibuffer-vc
    :defer t
    :init
    (progn
      (defun spacemacs//ibuffer-group-by-vc ()
        "Group buffers by vc."
        (when (eq 'vc ibuffer-group-buffers-by)
          (ibuffer-vc-set-filter-groups-by-vc-root)
          (unless (eq ibuffer-sorting-mode 'alphabetic)
            (ibuffer-do-sort-by-alphabetic))))
      (add-hook 'ibuffer-hook 'spacemacs//ibuffer-group-by-vc))))
